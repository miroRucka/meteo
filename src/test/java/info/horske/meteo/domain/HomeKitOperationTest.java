...
public class HomeKitOperationTest {
    ...
    public void parseTest() throws IOException {
        ...
        Assert.assertNotNull(result.get("meteo-bridge/temp/officein"));
        Assert.assertNotNull(result.get("meteo-bridge/hum/officein"));
        Assert.assertEquals(result.get("meteo-bridge/temp/officein"), 20.8);
        Assert.assertEquals(result.get("meteo-bridge/hum/officein"), 43.3);
    }
}
